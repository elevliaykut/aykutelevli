...
const ProjectsCard = () => {
    return (
        <>
            ...
            <ItemList>
                <Item>
                    <CustomEmoji label='past' emoji='✔️'></CustomEmoji> Nöbetçi takip sistemini oldukça kolaylaştıracak cross platform mobil uygulamam <BoldText> Win </BoldText>' i geliştirdim. <Date> (2020) </Date>
                </Item>
                <Item>
